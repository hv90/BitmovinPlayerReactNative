...
class BitmovinPlayer extends React.Component {
  ...
  getDuration = () =>
    RNBitmovinPlayerModule.getDuration(findNodeHandle(this._player));

  getVolume = () =>
    RNBitmovinPlayerModule.getVolume(findNodeHandle(this._player));
  ...
  isPaused = () =>
    RNBitmovinPlayerModule.isPaused(findNodeHandle(this._player));

  isStalled = () =>
    RNBitmovinPlayerModule.isStalled(findNodeHandle(this._player));

  isPlaying = () =>
    RNBitmovinPlayerModule.isPlaying(findNodeHandle(this._player));
...
const RNBitmovinPlayer = requireNativeComponent('RNBitmovinPlayer');
